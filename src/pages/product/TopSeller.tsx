        ...
        <div className='md:col-span-2'>
          ...
          <div className='grid md:grid-cols-2 m-[46px] '>
            <nav className='md:col-span-2'>
              <ul className='flex items-center justify-center space-x-5 text-justify'>
                {/* <li className='text-[26px] md:w-auto md:inline-block bg-black text-white p-[7px]'>TOP SELLER</li> */}
                <NavLink
                  className={({ isActive }) => (!isActive ? 'text-[26px]' : 'text-[26px] active_tag_product p-2')}
                  to={'topSeller'}
                >
                  TOP SELLER
                </NavLink>
                <NavLink
                  className={({ isActive }) => (!isActive ? 'text-[26px]' : 'bg-black text-[26px] active_tag_product p-2')}
                  to={'gift'}
                >
